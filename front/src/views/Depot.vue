                ...
                <v-col cols="12" sm="6">
                  <v-card-text class="mt-12">
                    ...
                    <h6 class="text-center grey--text">
                      Entrer  un montant possitif et une decription<br>
                    ...
                    <div >
                      <v-col cols="12" sm="8">
                        ...
                        <v-text-field label="montant" v-model="amount" outlined dense color="blue" type="number" min="2"></v-text-field>
                        ...
                        >
                            ...
                            <router-link to="/dashboard" class="routerLink">
                              ...
                              <div class="my-3">
                                <h1 style="color:green">Garder avec success</h1>
                                <p>Objectif du jour atteind</p>
                              </div>
                            </v-sheet>
                        </v-bottom-sheet>
                      </v-col>
